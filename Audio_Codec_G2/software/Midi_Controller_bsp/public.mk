...
JDI_FILE := C:/Users/Kyle/Desktop/MIDI-Synth/Audio_Codec_G2/MidiSynth.jdi
...
# Design Name 
# setting SOPC_NAME is SOPC_File
SOPC_NAME := SOPC_File
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1005100
SOPC_SYSID_FLAG += --sidp=0x1005100
ELF_PATCH_FLAG  += --sidp 0x1005100

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1332794990
SOPC_SYSID_FLAG += --timestamp=1332794990
ELF_PATCH_FLAG  += --timestamp 1332794990
